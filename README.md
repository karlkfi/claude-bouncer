...
| <img src="plugins/prod-guard/docs/img/favicon-48.png" width="24" height="24" alt=""> | [prod-guard](plugins/prod-guard) | 2.5.2 | Mutating `kubectl`/`helm`/`terraform`/`gcloud`/`aws` aimed at production, or relying on ambient context that can change under it |
