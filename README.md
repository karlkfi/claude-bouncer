...
| <img src="plugins/foreground-guard/docs/img/favicon-48.png" width="24" height="24" alt=""> | [foreground-guard](plugins/foreground-guard) | 0.7.0 | Polling and watching on the main thread, and slow commands about to be killed by too short a timeout |
