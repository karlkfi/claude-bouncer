...
| <a id="Q13"></a>Q13 | Add CI status badge to README once CI exists | `docs` | 🚫 | S | Blocked by [Q1](#Q1). Once a test suite and CI workflow land, add a workflow-run badge to the README badge row. A green CI badge with no CI is worse than no badge. |
