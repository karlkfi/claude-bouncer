...
Work is tracked in the repo-root backlog, [`docs/queue/`](../../docs/queue/README.md): pick the top ready item, run `gh pr list` before picking, and commit backlog changes in isolated `docs(status):` commits.
