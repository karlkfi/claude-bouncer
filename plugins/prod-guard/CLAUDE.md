...
| Rendering or regenerating brand images (social preview, favicon, icon) | `../../docs/development/rendering-images.md` — one procedure for all six asset directories |
