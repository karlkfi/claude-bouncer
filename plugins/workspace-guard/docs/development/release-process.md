...
tag names the plugin (`workspace-guard/vX.Y.Z`) because five version lines share one tag
namespace. There is nothing left that is true of workspace-guard alone.
